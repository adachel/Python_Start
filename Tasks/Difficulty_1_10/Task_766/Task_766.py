...
with open('D:\Works\IT\Python_Start\Tasks\1_10\Task_766\input.txt', 'r') as input_data:
    N, M, K = map(int, input_data.read().split())
summa = N * M
if summa >= K:
    res = 'YES'
else: res ='NO'
with open('D:\Works\IT\Python_Start\Tasks\1_10\Task_766\output.txt', 'w') as output_data:
